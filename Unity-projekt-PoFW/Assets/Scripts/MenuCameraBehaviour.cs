...
public class MenuCameraBehaviour : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        if(GUI.Button(new Rect(Screen.width * 0.1f, Screen.height * 0.12f + Screen.height * 0.11f * 2f, Screen.width / 5f, Screen.height / 10f), ChooseLevel, ""))
        {
            Application.LoadLevel(ChooseLevelScene);
        }
        if(GUI.Button(new Rect(Screen.width * 0.1f, Screen.height * 0.12f + Screen.height * 0.11f * 3f, Screen.width / 5f, Screen.height / 10f), BestScore, ""))
        {
            Application.LoadLevel(BestScoreScene);
        }
        if(GUI.Button(new Rect(Screen.width * 0.1f, Screen.height * 0.12f + Screen.height * 0.11f * 4f, Screen.width / 5f, Screen.height / 10f), Credits, ""))
        {
            Application.LoadLevel(CreditsScene);
        }
        if (GUI.Button(new Rect(Screen.width * 0.1f, Screen.height * 0.12f + Screen.height * 0.11f * 5f, Screen.width / 5f, Screen.height / 10f), Help, ""))
        {
